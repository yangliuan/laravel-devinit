...
trait MakerTrait
{
    ...
    {
        $this->files = $files;
        $this->devMakeCommandObjM = $devMakeCommandObj;

        $this->generateNames($this->devMakeCommandObjM);
    }
    ...
    protected function getStubFields($ui, $type)
    {
        ...
        {
            $this->devMakeCommandObjM->error('Stub not found');
            return;
        }
