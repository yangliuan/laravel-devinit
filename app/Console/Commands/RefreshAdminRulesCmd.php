    ...
    protected function getRulesData()
    {
        ...
        $rules = [
            ...
            [
                ...
                'gui_type' => 2, 'gui_behavior' => '/permission/admingroup', 'status' => 1, 'is_log' => 0, 'sort' => 1
            ],
            [
                'id' => 3, 'pid' => 2, 'name' => '添加管理组',
                'api_http_method' => 'POST', 'api_behavior' => 'api/admin/group', 'params' => '',
                'gui_type' => 3, 'gui_behavior' => '/permission/admingroup/create', 'status' => 0, 'is_log' => 1, 'sort' => 1
            ],
            [
                'id' => 4, 'pid' => 2, 'name' => '管理组详情',
                'api_http_method' => 'GET', 'api_behavior' => 'api/admin/group/', 'params' => '',
                'gui_type' => 3, 'gui_behavior' => '/permission/admingroup/edit/:id(\\d+)', 'status' => 0, 'is_log' => 0, 'sort' => 1
            ],
            [
            ...
            [
                ...
                'gui_type' => 2, 'gui_behavior' => '/permission/admin', 'status' => 1, 'is_log' => 0, 'sort' => 2
            ],
            [
                'id' => 9, 'pid' => 8, 'name' => '添加管理员',
                'api_http_method' => 'POST', 'api_behavior' => 'api/admin/admin', 'params' => '',
                'gui_type' => 3, 'gui_behavior' => '/permission/admin/create', 'status' => 0, 'is_log' => 1, 'sort' => 1
            ],
            [
                'id' => 10, 'pid' => 8, 'name' => '管理员详情',
                'api_http_method' => 'GET', 'api_behavior' => 'api/admin/admin/', 'params' => '',
                'gui_type' => 3, 'gui_behavior' => '/permission/admin/edit/:id(\\d+)', 'status' => 0, 'is_log' => 0, 'sort' => 1
            ],
            [
            ...
            [
                ...
                'gui_type' => 2, 'gui_behavior' => '/permission/syslog', 'status' => 1, 'is_log' => 0, 'sort' => 2
            ],
